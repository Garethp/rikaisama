...
var rcxMain = {
    ...
    readWordList: function (wordListFilePath, outputDic, wordColumn) {
        ...
        var textConverter = Components.classes["@mozilla.org/intl/scriptableunicodeconverter"].createInstance(Components.interfaces.nsIScriptableUnicodeConverter);
    ...
    addNoAudioListEntry: function (entry) {
        ...
        var utf8Converter = Components.classes["@mozilla.org/intl/converter-output-stream;1"].createInstance(Components.interfaces.nsIConverterOutputStream);
   ...
   */
    ...
    show: function (tdata) {
        ...
        if (rcxConfig.autoplayaudio) {
            ...
            this.autoPlayAudioTimer = setTimeout(function () {
                rcxMain.playJDicAudio(false)
            }, 500);
        }
        ...
        if (!this.superSticky || this.superStickyOkayToShow) {
            ...
            // If we are in EPWING mode and the normal non-names, non-kanji dictionary is selected
                ...
                this.epwingTimer = setTimeout(function () {
                    rcxMain.lookupEpwing()
                }, 0);
            }
            // Normal popup
